...
VILibrary.InnerObjects = {
    ...
    bindDataLine: function (sourceId, targetId, sourceOutputType, targetInputType) {
        ...
        if (!sourceVI.dataLine && !targetVI.dataLine) {//均未赋过值说明未与其他VI连接，赋一个未被占用的dataLine
            ...
            for (let VI of this.existingVIArray) {//遍历当前所有VI，dataline与sourceVI相同的VI将其改为较小的targetVI
...
VILibrary.VI = {
    ...
    KnobVI: class KnobVI extends TemplateVI {
        ...
        constructor (VICanvas) {
            ...
            Promise.all([p1, p2]).then(function () { _this.draw(); })
                   .catch(function (e) { console.log('KnobVI:' + e); });
    ...
    RRToothRingVI: class  RRToothRingVI extends TemplateVI {
        constructor(VICanvas, draw3DFlag) {
            ...
            let testerDown=true,errorArray=[0,3,5,-3,1,1.5,3,2.5,0,-3,0,3,5,-3,1,1.5,3,2.5,0,-3,0,3,5,-3,1,1.5,3,2.5,0,-3,0,3,5,-3,1,1.5,3,2.5,0,-3];
            ...
            this.getData = function (dataType) {
             ...
             /*let p1=new Promise(function (resolve,reject) {
                ...
                objLoader.onload=resolve;
                objLoader.onerror=reject;
            });
            p1.then(function () {
                renderScene();
            })
           ...
           this.draw();
            ...
            function RRDraw () {//相机、渲染、灯光、控制等初始设置
                ...
                //slider.translateY(-7.71);
                base.add(gear);
                base.add(slider,sliderMark);
                slider.add(tester);
                //slider.add(sliderMark);
                ...
                sliderControl.attachEvent('dragAndDrop', onRRDrag);
                ...
                gearControl.attachEvent('onclick', function () {
                    // let pointerAngle=0;
                    gear.rotateX(Math.PI/20);
                    this.gearNo+=1;
                    if(this.gearNo>=40)this.gearNo=0;
                    this.error=errorArray[this.gearNo];
                   // DialVI.InnerObjects.bindDataLine(ballBeamVI.id, positionWave.id, 2, 0);
                    //return pointerAngle;
            ...
            function onRRDrag () {
                ...
                //sliderMark.position.y = parseInt(this.focused.position.y);
            }
           ...
           /* mtlLoader.load('assets/RadialRunout_of_ToothRing/base.mtl', function (materials) {
                ...
                objLoader.load('assets/RadialRunout_of_ToothRing/base.obj', function (a) {
                    ...
                    base = a;
                    mtlLoader.load('assets/RadialRunout_of_ToothRing/beam.mtl', function (materials) {

                        materials.preload();

                        objLoader.setMaterials(materials);
                        objLoader.load('assets/RadialRunout_of_ToothRing/beam.obj', function (b) {
                            ...
                            beam = b;
                            mtlLoader.load('assets/RadialRunout_of_ToothRing/ball.mtl', function (materials) {

                                materials.preload();

                                objLoader.setMaterials(materials);
                                objLoader.load('assets/RadialRunout_of_ToothRing/ball.obj', function (c) {
                                    c.traverse(function (child) {
                                        if (child instanceof THREE.Mesh) {
                                    ...
                                    ball = c;
                                    mtlLoader.load('assets/RadialRunout_of_ToothRing/mark.mtl', function (materials) {

                                        materials.preload();

                                        objLoader.setMaterials(materials);
                                        objLoader.load('assets/RadialRunout_of_ToothRing/mark.obj', function (d) {
                                            d.traverse(function (child) {
                                                if (child instanceof THREE.Mesh) {
                                            ...
                                            mark = d;
                                            mtlLoader.load('assets/RadialRunout_of_ToothRing/offButton.mtl', function (materials) {

                                                materials.preload();

                                                objLoader.setMaterials(materials);
                                                objLoader.load('assets/RadialRunout_of_ToothRing/offButton.obj', function (e) {
                                                    e.traverse(function (child) {
                                                        if (child instanceof THREE.Mesh) {
                                                    ...
                                                    offButton = e;
                                                    mtlLoader.load('assets/RadialRunout_of_ToothRing/resetButton.mtl', function (materials) {

                                                        materials.preload();

                                                        objLoader.setMaterials(materials);
                                                        objLoader.load('assets/RadialRunout_of_ToothRing/resetButton.obj', function (f) {
                                                            f.traverse(function (child) {
                                                                if (child instanceof THREE.Mesh) {
                                                            ...
                                                            ballBeamDraw();
                                                            mtlLoader.load('assets/RadialRunout_of_ToothRing/onButton.mtl', function (materials) {

                                                                materials.preload();

                                                                objLoader.setMaterials(materials);
                                                                objLoader.load('assets/RadialRunout_of_ToothRing/onButton.obj', function (g) {
    ...
    DialVI:class DialVI extends TemplateVI{
        constructor (VICanvas) {
            ...
            // function draw(angle) {
                ...
                this.ctx.font=this.RADIUS/10+"px Verdana";
                this.ctx.textBaseline="middle";//文字居中定位
                let i=0;
                for(i;i<=50;i++){
                    this.angle0=-Math.PI/2+this.delta*i;
                    this.angle1=-Math.PI/2-this.delta*i;
                    this.line(i,this.angle0);//顺时针方向
                    this.line(i,this.angle1);//逆时针方向
                }
            ...
            this.line=function (i, angle){
                ...
                if(i%5) this.ctx.lineTo(this.RADIUS-this.SHORT_TICK,0);
                else {
            ...
            // function drag () {
            this.drag=function () {
                this.container.addEventListener("mousedown",startMove,false);
                this.container.addEventListener("mousemove",Moving,false);
                this.container.addEventListener("mouseup",endMove,false);
                this.container.addEventListener("mouseout",endMove,false);
            ...
            let Moving=function () {
                ...
                let drawAngle=0;
                if(dx>=0){ drawAngle = Math.atan( dy/ dx)+Math.PI/2;}
                else { drawAngle=Math.atan(dy/dx)+Math.PI*3/2;}
                _this.draw(drawAngle);
            };
